...
function AdminUpdateUser() {
  ...
  useEffect(() => {
    ...
    axios
      .get(baseURL + `/api/account-management/admin/users/${id}/`)
      .then((response) => {
  ...
  const handleDelete = () => {
    axios
      .delete(baseURL + `/api/account-management/admin/users/delete/${id}/`)
      .then((response) => {
        navigate("/admin");
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .put(baseURL + `/api/account-management/admin/users/update/${id}/`, userData, {
        headers: {
