...
function AdminHome() {
  ...
  const handleSearch = (query) => {
    ...
    fetchUsers(`${baseURL}/api/account-management/admin/users/?search=${query}`);
  };

  useEffect(() => {
    fetchUsers(baseURL + "/api/account-management/admin/users/");
  }, []);

  useEffect(() => {
    fetchUsers(`${baseURL}/api/account-management/admin/users/?search=${searchQuery}`);
  }, [searchQuery]);
